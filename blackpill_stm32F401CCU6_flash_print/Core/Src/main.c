...
// Print:
// open COM port in putty or stm32ide ( Open Control )
// 115200, data bit 7 , stop bit 1, parity Even, Flow Control None.
...
int main(void)
{
  ...
  /* USER CODE BEGIN WHILE */
	while (1) {
		...
		printf("Device Id not sure how to get,  flash size is %uKB\r\n",
				flashSize);
