...
// PA0 to GND (expect adc read 0),
// PA1 to mid point of 10K and 10K from 3.3V and GND( so expect 2048 (half of 4096) adc val for 1.65V)
// PA4 to 3.3V(4096).
/**
 ******************************************************************************
 * @file           : main.c
...
uint16_t read_adc(uint32_t channel)
{
	...
	uint16_t read_adc = HAL_ADC_GetValue(&hadc1);
	HAL_ADC_Stop(&hadc1);
	return read_adc;
