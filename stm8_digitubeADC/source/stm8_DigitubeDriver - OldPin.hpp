...
#define Segment_A_Port  GPIOD    //  stm8 pin 2       // new pin 18   PD1
#define Segment_A_Pin   GPIO_PIN_5

#define Segment_B_Port  GPIOC
#define Segment_B_Pin   GPIO_PIN_7   // 17           // new pin 5   PA1

#define Segment_C_Port  GPIOC
#define Segment_C_Pin   GPIO_PIN_3   // 13             //new pin 3   PD6

#define Segment_D_Port  GPIOA     //6                   // new pin 13   PC3
#define Segment_D_Pin   GPIO_PIN_2

#define Segment_E_Port  GPIOA    // 10                 //    new pin 14  PC4
#define Segment_E_Pin   GPIO_PIN_3

#define Segment_F_Port  GPIOD   // 3             //  new pin 17     PC7
#define Segment_F_Pin   GPIO_PIN_6

#define Segment_G_Port  GPIOC   // 14         //  new pin 16   PC6
#define Segment_G_Pin   GPIO_PIN_4

#define Segment_Dp_Port  GPIOA    // 5          //new pin 15   PC5
...
#define Segment_Digit2_Port  GPIOB    //12          //  new pin 1   PD4
#define Segment_Digit2_Pin   GPIO_PIN_4

#define Segment_Digit3_Port  GPIOB                     //new pin 2   PD5
#define Segment_Digit3_Pin   GPIO_PIN_5   //11

#define Segment_Digit4_Port  GPIOD   // 19             //new pin 10   PA3
